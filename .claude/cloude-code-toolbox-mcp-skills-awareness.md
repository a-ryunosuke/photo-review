...
_Generated: 2026-07-14T01:18:48.698Z_
...
Workspace `mcp.json` _(folder: photo-review)_

- **/Volumes/SSD/photo-review/.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **/Users/ryunosukearima/.claude.json** — _File exists — no servers defined_
